        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="name" class="form-control" placeholder="Client 01">
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label required">Key</label>
                    <div>
                        <input type="text" name="key" class="form-control" readonly value="{{ Str::random(16) }}">
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label required">Secret</label>
                    <div>
                        <input type="text" name="secret" class="form-control" readonly value="{{ Str::random(32) }}">
                    </div>
                </div>
                <div class="mb-3">
