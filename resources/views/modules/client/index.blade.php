    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('client.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <table class="table table-vcenter card-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('client.edit', $item->id) }}">Edit</a> | <a href="#" onclick="event.preventDefault(); document.getElementById('del-{{$item->id}}').submit();"> Delete <a>
                                <form id="del-{{$item->id}}" action="{{ route('client.destroy', $item->id) }}" method="POST" class="d-none">
                                    @method("DELETE")
                                    @csrf
                                </form>
                            </td>
