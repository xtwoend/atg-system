        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="manufacture" class="form-control" placeholder="Manufaktur">
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="topic" class="form-control" placeholder="mqtt/data/device/1">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div>
                        <select class="form-select" name="handler">
                            ...
                            <option value="{{ $handler }}">{{ $key }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
