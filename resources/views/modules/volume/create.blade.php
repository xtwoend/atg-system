    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('atgsetting.table-volume.index') }}?time={{ time() }}" class="btn btn-default d-none d-sm-inline-block">
    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Upload Volume Table</div>
                <div class="card-actions">
                    <a href="{{ asset('volume-template.xlsx') }}" class="btn">
            ...
            <form method="POST" action="{{ route('atgsetting.table-volume.store') }}" enctype="multipart/form-data">
                @csrf
            <div class="card-body">
                <div class="mb-3">
