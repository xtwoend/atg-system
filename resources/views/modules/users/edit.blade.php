        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="name" class="form-control" placeholder="Mr. Joe" value="{{ old('name', $row->name) }}">
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label required">Email</label>
                    <div>
                        <input type="text" name="email" class="form-control" placeholder="example@domain.com" value="{{ old('email', $row->email) }}">
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <select class="form-control" name="role">
                            <option value="admin" @if($row->role == 'admin') selected @endif>Administrator</option>
                            <option value="operator" @if($row->role == 'operator') selected @endif>Operator</option>
                        </select>
                    </div>
                </div>
